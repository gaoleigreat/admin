...
public class SysLogininforController {
    ...
    public RespVO<PageInfo<SysLogininfor>> queryPageByCondition(@RequestBody SysLogininfor sysLogininfor) {
        PageHelper.startPage(sysLogininfor.getPageIndex(),sysLogininfor.getPageSie());
        List<SysLogininfor> list = sysLogininforService.queryByCondition(sysLogininfor);
    ...
    public RespVO<PageInfo<SysLogininfor>> queryPageFuzzy(@RequestBody SysLogininfor sysLogininfor) {
        PageHelper.startPage(sysLogininfor.getPageIndex(),sysLogininfor.getPageSie());
        List<SysLogininfor> list = sysLogininforService.queryFuzzy(sysLogininfor);
        return RespVOBuilder.success(new PageInfo(list));
    }
    ...
    public RespVO<PageInfo<SysLogininfor>> queryPageByLikeCondition(@RequestBody SysLogininfor sysLogininfor) {
        PageHelper.startPage(sysLogininfor.getPageIndex(),sysLogininfor.getPageSie());
        List<SysLogininfor> list = sysLogininforService.queryByLikeCondition(sysLogininfor);
        return RespVOBuilder.success(new PageInfo(list));
    }
