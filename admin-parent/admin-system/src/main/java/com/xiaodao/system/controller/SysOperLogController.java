...
public class SysOperLogController {
    ...
    public RespVO insert(@RequestBody SysOperLog sysOperLog) {
        ...
        int resultNum = sysOperLogService.insert(sysOperLog);
        if (resultNum == 0) {
    ...
    public RespVO insertSelective(@RequestBody SysOperLog sysOperLog) {
        int resultNum = sysOperLogService.insertSelective(sysOperLog);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入失败");
        } else {
            return RespVOBuilder.success("插入成功");
    ...
    public RespVO batchInsert(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchInsert(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入失败");
        } else {
            return RespVOBuilder.success("插入成功");
    ...
    public RespVO batchInsertSelective(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchInsertSelective(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入失败");
        } else {
            return RespVOBuilder.success("插入成功");
    ...
    public RespVO updateByPrimaryKey(@RequestBody SysOperLog sysOperLog) {
        int resultNum = sysOperLogService.updateByPrimaryKey(sysOperLog);
        if (resultNum == 0) {
    ...
    public RespVO updateSelectiveByPrimaryKey(@RequestBody SysOperLog sysOperLog) {
        int resultNum = sysOperLogService.updateSelectiveByPrimaryKey(sysOperLog);
        if (resultNum == 0) {
            return RespVOBuilder.failure("更新失败");
        } else {
            return RespVOBuilder.success("更新成功");
    ...
    public RespVO batchUpdate(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchUpdate(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("更新失败");
        } else {
            return RespVOBuilder.success("更新成功");
    ...
    public RespVO batchUpdateSelective(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchUpdateSelective(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("更新失败");
        } else {
            return RespVOBuilder.success("更新成功");
    ...
    @PostMapping("/upsert")
    public RespVO upsert(@RequestBody SysOperLog sysOperLog) {
        int resultNum = sysOperLogService.upsert(sysOperLog);
        if (resultNum == 0) {
    ...
    public RespVO upsertSelective(@RequestBody SysOperLog sysOperLog) {
        int resultNum = sysOperLogService.upsertSelective(sysOperLog);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入更新失败");
        } else {
            return RespVOBuilder.success("插入更新成功");
    ...
    public RespVO batchUpsert(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchUpsert(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入更新失败");
        } else {
            return RespVOBuilder.success("插入更新成功");
    ...
    public RespVO batchUpsertSelective(@RequestBody List<SysOperLog> list) {
        int resultNum = sysOperLogService.batchUpsertSelective(list);
        if (resultNum == 0) {
            return RespVOBuilder.failure("插入更新失败");
        } else {
            return RespVOBuilder.success("插入更新成功");
    ...
    public RespVO deleteByPrimaryKey(@PathVariable(value = "operId") Long operId) {
        Integer resultNum = sysOperLogService.deleteByPrimaryKey(operId);
        if (resultNum == 0) {
    ...
    public RespVO deleteBatchByPrimaryKeys(@RequestBody List<Long> list) {
        int resultNum = sysOperLogService.deleteBatchByPrimaryKeys(list);
        if (resultNum > 0) {
            return RespVOBuilder.success("删除成功");
        } else {
            return RespVOBuilder.failure("删除失败");
    ...
    public RespVO delete(@RequestBody SysOperLog sysOperLog) {

        int resultNum = sysOperLogService.delete(sysOperLog);
        if (resultNum > 0) {
            return RespVOBuilder.success("删除成功");
        } else {
            return RespVOBuilder.failure("删除失败");
    ...
    @GetMapping("/{operId}")
    public RespVO<SysOperLog> queryByPrimaryKey(@PathVariable(value = "operId") Long operId) {
        SysOperLog sysOperLog = sysOperLogService.queryByPrimaryKey(operId);
    ...
    public RespVO<RespDataVO<SysOperLog>> queryBatchPrimaryKeys(@RequestBody List<Long> list) {
        List< SysOperLog> sysOperLogs = sysOperLogService.queryBatchPrimaryKeys(list);
        return RespVOBuilder.success(sysOperLogs);
    }
    ...
    public RespVO<SysOperLog> queryOne(@RequestBody SysOperLog sysOperLog) {
        sysOperLog =sysOperLogService.queryOne(sysOperLog);
        return RespVOBuilder.success(sysOperLog);
    }
    ...
    public RespVO<RespDataVO<SysOperLog>> queryByCondition(@RequestBody SysOperLog sysOperLog) {
    ...
    public RespVO<RespDataVO<SysOperLog>> queryFuzzy(@RequestBody SysOperLog sysOperLog) {
    ...
    public RespVO<Long> queryCount(@RequestBody SysOperLog sysOperLog) {
        long count = sysOperLogService.queryCount(sysOperLog);
    ...
    public RespVO<RespDataVO<Map<String, Object>>> statisticsGroup(@RequestBody SysOperLog sysOperLog) {
        List<Map<String, Object>> maps = sysOperLogService.statisticsGroup(sysOperLog);
    ...
    public RespVO<RespDataVO<Map<String, Object>>> statisticsGroupByDay(@RequestBody SysOperLog sysOperLog) {
        List<Map<String, Object>> maps = sysOperLogService.statisticsGroupByDay(sysOperLog);
        return RespVOBuilder.success(maps);
    }
    ...
    public RespVO<RespDataVO<Map<String, Object>>> statisticsGroupByMonth(@RequestBody SysOperLog sysOperLog) {
        List<Map<String, Object>> maps = sysOperLogService.statisticsGroupByMonth(sysOperLog);
        return RespVOBuilder.success(maps);
    }
    ...
    public RespVO<RespDataVO<Map<String, Object>>> statisticsGroupByYear(@RequestBody SysOperLog sysOperLog) {
        List<Map<String, Object>> maps = sysOperLogService.statisticsGroupByYear(sysOperLog);
        return RespVOBuilder.success(maps);
    }
