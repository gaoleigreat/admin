...
public class SysDictTypeController {
    ...
    public RespVO<PageInfo<SysDictType>> queryPageByCondition(@RequestBody SysDictType sysDictType) {
        PageHelper.startPage(sysDictType.getPageIndex(),sysDictType.getPageSie());
        List<SysDictType> list = sysDictTypeService.queryByCondition(sysDictType);
    ...
    public RespVO<PageInfo<SysDictType>> queryPageFuzzy(@RequestBody SysDictType sysDictType) {
        PageHelper.startPage(sysDictType.getPageIndex(),sysDictType.getPageSie());
        List<SysDictType> list = sysDictTypeService.queryFuzzy(sysDictType);
        return RespVOBuilder.success(new PageInfo(list));
    }
    ...
    public RespVO<PageInfo<SysDictType>> queryPageByLikeCondition(@RequestBody SysDictType sysDictType) {
        PageHelper.startPage(sysDictType.getPageIndex(),sysDictType.getPageSie());
        List<SysDictType> list = sysDictTypeService.queryByLikeCondition(sysDictType);
        return RespVOBuilder.success(new PageInfo(list));
    }
