...
public class SysRoleMenuController {
    ...
    public RespVO<PageInfo<SysRoleMenu>> queryPageByCondition(@RequestBody SysRoleMenu sysRoleMenu) {
        PageHelper.startPage(sysRoleMenu.getPageIndex(),sysRoleMenu.getPageSie());
        List<SysRoleMenu> list = sysRoleMenuService.queryByCondition(sysRoleMenu);
    ...
    public RespVO<PageInfo<SysRoleMenu>> queryPageFuzzy(@RequestBody SysRoleMenu sysRoleMenu) {
        PageHelper.startPage(sysRoleMenu.getPageIndex(),sysRoleMenu.getPageSie());
        List<SysRoleMenu> list = sysRoleMenuService.queryFuzzy(sysRoleMenu);
        return RespVOBuilder.success(new PageInfo(list));
    }
    ...
    public RespVO<PageInfo<SysRoleMenu>> queryPageByLikeCondition(@RequestBody SysRoleMenu sysRoleMenu) {
        PageHelper.startPage(sysRoleMenu.getPageIndex(),sysRoleMenu.getPageSie());
        List<SysRoleMenu> list = sysRoleMenuService.queryByLikeCondition(sysRoleMenu);
        return RespVOBuilder.success(new PageInfo(list));
    }
