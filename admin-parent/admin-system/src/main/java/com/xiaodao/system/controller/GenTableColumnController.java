...
public class GenTableColumnController {
    ...
    public RespVO<PageInfo<GenTableColumn>> queryPageByCondition(@RequestBody GenTableColumn genTableColumn) {
        PageHelper.startPage(genTableColumn.getPageIndex(),genTableColumn.getPageSie());
        List<GenTableColumn> list = genTableColumnService.queryByCondition(genTableColumn);
    ...
    public RespVO<PageInfo<GenTableColumn>> queryPageFuzzy(@RequestBody GenTableColumn genTableColumn) {
        PageHelper.startPage(genTableColumn.getPageIndex(),genTableColumn.getPageSie());
        List<GenTableColumn> list = genTableColumnService.queryFuzzy(genTableColumn);
        return RespVOBuilder.success(new PageInfo(list));
    }
    ...
    public RespVO<PageInfo<GenTableColumn>> queryPageByLikeCondition(@RequestBody GenTableColumn genTableColumn) {
        PageHelper.startPage(genTableColumn.getPageIndex(),genTableColumn.getPageSie());
        List<GenTableColumn> list = genTableColumnService.queryByLikeCondition(genTableColumn);
        return RespVOBuilder.success(new PageInfo(list));
    }
