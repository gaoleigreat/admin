package com.xiaodao.redis.aspect;

import com.xiaodao.redis.annotation.RedisCache;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.xiaodao.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.xiaodao.redis.annotation.RedisEvict)")
