...
import com.xiaodoa.fileview.core.office.OfficeContext;
import com.xiaodoa.fileview.core.office.OfficeException;
import com.xiaodoa.fileview.core.office.OfficeTask;

import java.io.File;
import java.util.Map;

import static com.xiaodoa.fileview.core.office.OfficeUtils.*;
...
public abstract class AbstractConversionTask implements OfficeTask {
    ...
    private XComponent loadDocument(OfficeContext context, File inputFile) throws OfficeException, IllegalArgumentException {
        if (!inputFile.exists()) {
